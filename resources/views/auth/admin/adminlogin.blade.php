...
@section('title', 'Admin Login - LAPOR PAL')
...
<div class="container mx-auto px-2 py-6 flex-grow flex items-center justify-center mt-12">
    <div class="w-full max-w-2xl mx-auto bg-kuning shadow-2xl rounded-2xl overflow-hidden">
        <div class="p-8 md:p-12">
            <h1 class="text-3xl font-bold text-center mb-8 text-hitam">Admin Login</h1>
                ...
                <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-8">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-hitam text-sm">
                            ...
                            <a href="{{ route('admin.register') }}" class="text-biru font-semibold hover:text-opacity-80 transition-colors">Register here</a>
                        </p>
                    </div>
                </form>
            </div>
