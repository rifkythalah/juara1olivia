                ...
                <form action="{{ route('admin.register.submit') }}" method="POST" class="space-y-8">
                            ...
                            <div class="rounded-lg form-field transition-transform duration-200">
                                ...
                                <div class="relative">
                                    <input type="password" id="password" name="password" placeholder="Masukkan password"
                                        ...
                                        required>
                                    <button type="button" id="togglePassword" onclick="togglePassword('password', 'togglePassword')" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-gray-800 focus:outline-none">
                            ...
                            <div class="rounded-lg form-field transition-transform duration-200">
                                ...
                                <div class="relative">
                                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Konfirmasi password"
                                        ...
                                        required>
                                    <button type="button" id="toggleConfirmPassword" onclick="togglePassword('password_confirmation', 'toggleConfirmPassword')" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-gray-800 focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                        </svg>
                                    </button>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-hitam text-sm">
                            ...
                            <a href="{{ route('admin.login') }}" class="text-biru font-semibold hover:text-opacity-80 transition-colors">Login here</a>
                        </p>
                    </div>
                </form>
            </div>
