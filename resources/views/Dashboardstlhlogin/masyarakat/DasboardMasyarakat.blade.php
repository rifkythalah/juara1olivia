...
<section id="home" class="container bg-white p-6 mx-auto max-w-7xl">
    <div class="flex flex-col-reverse md:flex-row items-center justify-between">
        ...
        <div class="text-section flex-1 px-6 mb-8 md:mb-0">
            ...
            <button><a href="/masyarakat/pengaduan" class="bg-kuning hover:ring-2 ring-yellow-300 hover:bg-white hover:text-kuning transition-colors text-white py-1 px-6 rounded-full flex items-center gap-2">
                <span class="text-[20px] md:text-[26px] font-bold">Lapor.pal</span>
                <span class="flex items-center">
                    <img src="{{ asset('img/Desain/Megefone.png') }}" alt="Icon Laporan" width="67" height="35" />
                </span>
            </a></button>
        </div>
