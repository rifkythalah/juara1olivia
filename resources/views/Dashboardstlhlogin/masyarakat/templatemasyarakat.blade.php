                            ...
                            <div class="relative">
                                <div class="profile-button flex items-center focus:outline-none cursor-pointer" onclick="toggleDropdown()">
                                    <div class="w-8 h-8 rounded-full overflow-hidden border-2 border-gray-300">
                                        <img src="{{ Auth::user()->masyarakat->foto_profil ? 'data:image/jpeg;base64,' . base64_encode(Auth::user()->masyarakat->foto_profil) : asset('img/logo/profil.png') }}"
                                             alt="Profil Lapor.Pal"
