...
<section class="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-12">
    <div class="container mx-auto px-8">
        ...
        <div class="w-full h-1 bg-yellow-400 mb-8"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 space-y-8">
                ...
                <div class="border-4 border-kuning rounded-xl shadow-xl overflow-hidden">
                    <img id="image-modal-trigger"
                         src="{{ asset('storage/' . $laporan->foto_video) }}"
                         alt="Foto Laporan"
                         class="w-full h-96 md:h-[500px] object-cover rounded-xl transform hover:scale-105 transition duration-500 cursor-pointer">
                </div>

                <!-- Rejection Reason Card -->
                <div class="bg-white rounded-xl shadow-xl p-4 border border-gray-200">
                    <div class="flex items-center mb-6">
                        <div class="h-10 w-1 bg-gradient-to-b from-yellow-400 to-yellow-300 rounded-full mr-4"></div>
                        <h2 class="text-2xl font-bold text-gray-800">Pesan Pusat</h2>
                    </div>
                    <div class="pl-5 space-y-4 border-l-4 border-yellow-100">
                        <p class="text-gray-700 text-lg leading-relaxed">{{ $isi_pesan }}</p>
                        <div class="flex items-center text-gray-400 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            {{ \Carbon\Carbon::parse($waktu_kirim)->format('d M Y • H:i') }} WIB
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-6 text-gray-600">
                    <span class="flex items-center space-x-2 hover:text-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mb-10">
                    ...
                    <div class="relative mt-8 pl-6">
                        ...
                        <div class="space-y-10">
                            ...
                            <form action="{{ route('dinas.laporan.step4.diproses', $laporan->id) }}" method="GET" style="display:inline;">
                                <button type="submit" class="flex-1 px-3 py-3 w-full bg-merah text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-600 transition duration-300 flex items-center justify-center shadow-md">
...
<div id="image-modal" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden justify-center items-center z-50">
    <div class="relative bg-white p-8 rounded-lg max-w-4xl mx-4">
        <span id="close-modal" class="absolute top-4 right-4 text-3xl font-bold text-gray-500 cursor-pointer">&times;</span>
