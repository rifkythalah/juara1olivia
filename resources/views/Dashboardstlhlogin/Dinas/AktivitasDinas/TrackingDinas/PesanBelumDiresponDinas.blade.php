...
<div id="notificationModal" class="fixed inset-0  flex items-center justify-center p-4 z-[100] hidden">
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-auto">
        ...
        <div class="p-6">
            ...
            <textarea rows="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-kuning" placeholder="berikan tanggapanmu..."></textarea>

            {{-- Footer Modal (Tombol) --}}
            <div class="flex justify-end space-x-3 mt-6"> {{-- Menggunakan justify-end untuk tata letak tombol standar --}}
                ...
                <button type="button" id="sendNotificationBtn" class="px-6 py-2.5 bg-kuning text-hitam rounded-lg hover:bg-yellow-500 transition-colors shadow-md flex items-center">
    ...
    <div class="w-full h-1 bg-yellow-400 mb-4 sm:mb-6"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7">
              ...
              <div class="bg-white rounded-xl shadow-lg p-6 border my-8 border-gray-200">
                <div class="flex items-center mb-4">
                    <div class="h-8 w-1 bg-yellow-400 rounded-full mr-3"></div>
                    <h2 class="text-xl font-semibold text-gray-800">Pesan Pusat</h2>
                </div>
                <p class="text-gray-700 pl-4">{{ $isi_pesan }}</p>
                <p class="text-gray-400 pl-4 text-xs">Waktu Pengiriman: {{ \Carbon\Carbon::parse($waktu_kirim)->format('d M Y • H:i') }} WIB</p>
            </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-xl p-8 h-full">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="relative mt-8 pl-6">
                            ...
                            <form action="{{ route('dinas.laporan.tindaklanjuti', $laporan->id) }}" method="POST" style="display:inline;">
                                @csrf
