                ...
                <div class="bg-white rounded-xl shadow-xl p-8 h-full">
                    ...
                    <div class="pt-6">
                        <form onsubmit="event.preventDefault(); showConfirmModal();">
                            @csrf
                            <button type="button" onclick="showConfirmModal()" class="px-8 py-3 bg-kuning text-white font-bold rounded-full hover:bg-yellow-600 transition-colors">
                                Selesaikan
                            </button>
                        </form>
                    </div>
...
<div id="confirmModal" class="fixed inset-0 backdrop-blur-sm bg-opacity-50 z-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-3xl shadow-xl p-8 max-w-md w-full mx-4">
        ...
        <form action="{{ route('dinas.laporan.selesaikanStep6', ['id' => $laporan->id]) }}" method="POST">
            ...
            <div class="flex justify-center space-x-4">
                ...
                <button type="submit" class="px-8 py-3 bg-kuning text-white font-bold rounded-full hover:bg-yellow-600 transition-colors">
                    Selesaikan
                </button>
            </div>
        </form>
