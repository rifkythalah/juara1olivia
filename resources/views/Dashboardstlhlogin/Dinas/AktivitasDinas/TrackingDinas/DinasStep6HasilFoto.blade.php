    ...
    <div class="w-full h-1 bg-yellow-400 mb-4 sm:mb-6"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7">
                ...
                <!-- After Photo -->
                <div class="bg-white rounded-xl shadow-xl overflow-hidden border-4 border-green-500 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-xl p-8 h-full">
                    ...
                    <div class="pt-6">
                        <form onsubmit="event.preventDefault(); showConfirmModal();">
                            @csrf
                            <button type="button" onclick="showConfirmModal()" class="px-8 py-3 bg-blue-500 text-white font-bold rounded-full hover:bg-blue-600 transition-colors">
                                Selesaikan
                            </button>
                        </form>
                    </div>
...
<div id="confirmModal" class="fixed inset-0  bg-opacity-50 z-50 flex items-center justify-center hidden">
    <div class="bg-kuning rounded-3xl shadow-xl p-8 max-w-md w-full mx-4">
        ...
        <form action="{{ route('dinas.laporan.selesaikanStep6', ['id' => $laporan->id]) }}" method="POST">
            @csrf
            <div class="flex justify-center space-x-4">
                <button type="button" onclick="closeConfirmModal()" class="px-8 py-3 bg-red-600 text-white font-bold rounded-full hover:bg-red-700 transition-colors">
                    Belum Selesai
                </button>
                <button type="submit" class="px-8 py-3 bg-blue-500 text-white font-bold rounded-full hover:bg-blue-600 transition-colors">
                    Selesaikan
                </button>
            </div>
        </form>
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-95 opacity-0 border border-gray-200 pointer-events-auto">
        <div class="p-6 relative">
            ...
            <div class="flex justify-center pt-2">
                <button onclick="window.location.href='{{ route('dinas.laporan.step7.validasi', ['id' => $laporan->id]) }}';" class="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-colors shadow-md">
                    Selesaikan Laporan
                </button>
            </div>
        </div>
