...
<div id="notificationModal" class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-[100] hidden">
    {{-- Panel Modal --}}
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-auto">
        {{-- Header Modal --}}
        <div class="bg-kuning px-4 py-3 rounded-t-lg flex justify-between items-center">
            <h3 class="text-lg font-bold text-hitam">Peringatan: Laporan Pengaduan Tidak Ditindaklanjuti</h3>
            <button type="button" id="closeModalHeaderBtn" class="text-hitam hover:text-gray-700 text-2xl">&times;</button>
        </div>

        {{-- Body Modal --}}
        <div class="p-6">
            <p class="text-sm text-gray-700 mb-2">Kepada Pemerintah Daerah,</p>
            ...
            <div class="flex justify-end space-x-3 mt-6">
                ...
                <button type="button" id="sendNotificationBtn" class="px-6 py-2.5 bg-kuning text-hitam rounded-lg hover:bg-yellow-500 transition-colors shadow-md flex items-center">
                    ...
                    <img src="{{ asset('img/icon/kirim.svg') }}" class="w-4 h-3 ml-2">
                </button>
            </div>
        </div>
    </div>
...
<section class="bg-gray-50 min-h-screen">
    ...
    <div class="flex justify-between items-center mb-4 sm:mb-6">
            ...
            <a href="/pemerintahpusat/laporan" class="text-hitam hover:text-kuning transition-colors">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (sendBtn) {
            sendBtn.addEventListener('click', function() {
                ...
                alert('Notifikasi berhasil dikirim ke Pemerintah Daerah');
                closeModal();
            });
        }
