...
<section class="p-6">
    ...
    <div class="max-w-6xl mx-auto mb-8">
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <select class="px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                <option value="">Filter Kategori</option>
                <option value="Diproses">On-Proggres</option>
                <option value="BelumDiproses">Selesai</option>
                <option value="TidakTerselesaikan">Tidak Terselesaikan</option>
            </select>
        </div>
    </div>
        ...
        <div class="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card group relative bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4 border-green-500">
             ...
             <div class="card group relative bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4 border-red-500">
                ...
                <a href="/detail-laporan/4" class="block">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('img/Desain/foto.png') }}" alt="Selokan Mampet" class="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-105">
                    </div>
                    <div class="p-5">
                        <div class="flex justify-between items-start">
                            <h3 class="text-xl font-bold text-gray-800 mb-2 group-hover:text-yellow-600 transition-colors">Selokan Mampet</h3>
                            <span class="text-sm text-gray-500">1 minggu lalu</span>
                        </div>
                        <p class="text-gray-600 mb-4 line-clamp-2">Selokan depan rumah warga RT 03 mampet parah dan sudah meluap ke jalan...</p>
                    </div>
                </a>
                <div class="px-5 pb-5 pt-0">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/detail-laporan/4" class="text-yellow-600 font-medium hover:text-yellow-700 transition-colors">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
